...
def main():
    ...
    #for every person in people, i = 0, found = 1, for key, if key diverso da name e found = 1, if int dell"item of key diverso da counts[i] allora esci>>found = 0 else aumenta i
    ris = False
